...
export class DataStorageService {
  ...
  storeRecipes() {
    ...
    //   // headers: headers
    // });
    const req = new HttpRequest('PUT', 'https://ng-recipe-book-838b7.firebaseio.com/recipes.json', this.recipeService.getRecipes(), {reportProgress: true});
  ...
  getRecipes() {
    ...
    this.httpClient.get<Recipe[]>('https://ng-recipe-book-838b7.firebaseio.com/recipes.json', {
      observe: 'body',
      responseType: 'json'
    })
      .map(
